...
Network = [Perceptron([1,1],1), Perceptron([1,1,-2],0)]
...
def EvalNetwork(inputValues, Network):
    ...
    # YOUR CODE HERE
    OrOut = Network[0].activate(inputValues);
    OutputValue = Network[1].activate(np.append(inputValues, OrOut));   # Activate the XOR Perceptron
